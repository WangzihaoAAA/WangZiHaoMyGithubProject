...
<title>Insert title here</title>
	...
	function tianjiadaogouwuche() {
		  document.getElementById("tianjiagouwuche").click();
	}
	</script>
</head>
	...
	<div class="ck_navigation_main_wrapper ck_navigation_inner_main_wrapper float_left">
		<div class="container-fluid">
			...
			<div class="ck_navigation_right_wrapper">
					...
					<div class="content content--demo-3">
						...
						<div class="global-menu">
									<div class="global-menu__wrap" id='cssmenu'>
										<ul>
											<li ><a class="global-menu__item global-menu__item--demo-3" href="#">首页</a>
										
									</li>
											<li><a class="global-menu__item global-menu__item--demo-3" href="about_us.html">关于</a>
											</li>
											...
											<li class="has-sub"><a class="global-menu__item global-menu__item--demo-3" href="#">购买</a>
												<ul>
													<li><a href="checout.html" class="global-menu__item global-menu__item--demo-3">结账</a>
													</li>
				...
				<div class="ck_login_btn">	<a href="#" data-toggle="modal" data-target="#myModal"><i class="flaticon-login-square-arrow-button-outline"></i></a>
				</div>
										...
										<div class="col-lg-4 col-md-6 col-sm-6 col-12">
											<div class="ck_elem_slide_img_wrapper ck_elem_slide_img_wrapper_inner float_left">
												<div class="ck_elem_slide_img float_left">
													<img src="../image/${vgood.gpicture}.jpg" alt="img"  height="286px" width="150px"  >>
												</div>
												<div class="ck_elem_slide_img_cont ck_elem_slide_img_cont_inner float_left">
													<h3><a href="#" >${vgood.gname} </a></h3>
													
													<p>${vgood.gdetail}</p>
													<h5>${vgood.gprice}￥</h5>
													<form action="${pageContext.request.contextPath}/goods/goodslist?gname=${vgood.gname}" method="post">
																		<p>数量：</p><input type="text" name="number" required><br>
																		<input type="submit" value="添加购物车" id="tianjiagouwuche" style="display:none"  >
																		</form>
													<div class="ck_offer_btn ck_offer_btn_inner float_left">	
													<a href="#" onclick="tianjiadaogouwuche()">添加到购物车</a>
													</div>
												</div>
											</div>
										</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					<div class="btm_foter_box">
						<p>Copyright © 2019 <a href="#"> Cool Town</a> Template by <a href="http://www.bootstrapmb.com/"> Reserved</a>
						</p>
					</div>
				</div>
			</div>
	...
	<div class="modal fade st_pop_form_wrapper" id="myModal" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="st_form_pop_login_btn float_left">	<a href="">LOGIN</a>
				</div>
