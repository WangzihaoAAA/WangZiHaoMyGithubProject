...
<meta content="width=device-width, initial-scale=1.0" name="viewport" />
	...
	window.onload =function()
	{
		...
		document.getElementById("welcomeyou").click();
	}
	</script>
	 <script type="text/javascript" >
	window.onload =function()
			...
			<div class="container">
				<div class="ck_menu_inner float_left">
					...
					<div class="ck_navigation_right_wrapper">
								...
								<div class="global-menu">
									<div class="global-menu__wrap" id='cssmenu'>
										<ul>
											...
											<li><a class="global-menu__item global-menu__item--demo-3" href="${pageContext.request.contextPath}/user/userseting">个人中心</a>
											</li>
										</ul>
									</div>
								</div>
						...
						<div class="ck_login_btn">	<a href="#" data-toggle="modal" data-target="#myModal"><i class="flaticon-login-square-arrow-button-outline" id="welcomeyou" style="display:none"></i></a>
						</div>
						
						<div class="mainmenu d-xl-block d-lg-block d-md-block d-sm-none d-none">
							<ul class="main_nav_ul">
							                      <!-- 点击跳转到首页 -->
								<li class="has-mega gc_main_navigation">	<a href="${pageContext.request.contextPath}/user/toshouyeloging"" class="gc_main_navigation">  首页</a>
									<!-- mega menu start -->
								...
								<li class="has-mega gc_main_navigation">	<a href="#" class="gc_main_navigation">  商品</a>
									<!-- mega menu start -->
									<ul>
										<li class="parent"><a href="${pageContext.request.contextPath}/goods/selectall">臻选商品</a>
										</li>																	
									</ul>
								</li>
								<li class="has-mega gc_main_navigation">	<a href="#" class="gc_main_navigation">  购买</a>
									...
									<ul>
										...
										<li class="parent"><a href="${pageContext.request.contextPath}/goods/showcart">购物车</a>
										
									</ul>
								</li>
								
								<li class="has-mega gc_main_navigation">	<a href="contact.html" class="gc_main_navigation">个人</a>
							<ul>
								<li class="parent"><a href="${pageContext.request.contextPath}/user/userseting">个人中心</a></li>
								<li class="parent"><a href="${pageContext.request.contextPath}/user/outline">退出登录</a></li>
							</ul>
...
抓住TA的心！</h3>
							<ul>
								...
								<li><a href="${pageContext.request.contextPath}/goods/selectall">来挑选吧！</a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="st_pop_form_heading_wrapper float_left">
					<h3>你好,${sessionScope.nowuser.getUsername()}</h3>
				</div>
